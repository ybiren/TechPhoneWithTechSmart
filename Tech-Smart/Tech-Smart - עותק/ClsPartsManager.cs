            ...
            try
            {
                if (op == "insCall")
                {
                    foreach (var part in lstParts)
                    {
                        ...
                        var strResult = WebReq.DoRequest("http://ec2-52-37-115-198.us-west-2.compute.amazonaws.com/tech_post.php", qryStr);
                    }
                }
                else
                {
                    ...
                    WebReq.DoRequest("http://ec2-52-37-115-198.us-west-2.compute.amazonaws.com/tech_post.php", "op=makePartsDirty");
